...
export function preloadAdjacentGames(currentIndex, games) {
...
export function preloadBackgrounds(prevGame, currGame, nextGame) {
...
export function queuePreload(url, priority = 0) {
  if (!url) return;

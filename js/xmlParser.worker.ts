// js/xmlParser.worker.js
// Web Worker pour parser le XML en arrière-plan
...
self.onmessage = function(e) {
  ...
  try {
    ...
    const games: Array<{ title: string; rom: string; short: string; console: string; genre: string; year: string; pub: string; playersNum: number | null; playersRange: null; isClone: boolean; driver: string; resolution: string; }> = [];
